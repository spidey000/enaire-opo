...
import { Candidato, CandidatoFase3 } from '@/lib/parseCSV'
...
export default function Home() {
  ...
  const isPhaseWithData = phase === 'fase1' || phase === 'fase3a'
  ...
  const recordCount = phase === 'fase1' ? displayDataFase1.length : displayDataFase3a.length
  ...
  return (
    <div className="min-h-screen bg-background font-sans text-foreground">
      ...
      <main className="max-w-screen-xl mx-auto px-6 py-10 space-y-10">
        {(fase1Loading || (isFase3 && fase3aLoading)) && (
          ...
          <>
            <div>
              ...
              <h1 className="text-3xl font-bold text-foreground text-balance leading-tight">
                Listado Provisional {phase === 'fase1' ? 'Fase 1' : phase === 'fase2' ? 'Fase 2' : isFase3 ? `Fase 3${phase.replace('fase3', ' - ')}` : ''}
              </h1>
            ...
            {!isPhaseWithData && (
              <div className="space-y-4">
                ...
                {phase === 'fase2' && (
                  <div className="rounded border border-amber-300 bg-amber-50 p-4 text-sm text-amber-800">
                    No hay datos disponibles todavía para Fase 2.
                  </div>
                )}
      ...
      <footer id="informacion" className="border-t border-border mt-16 py-6 px-6 bg-card scroll-mt-20">
        <div className="max-w-screen-xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-xs text-muted-foreground">Listado Provisional de Resultados — Fase 1 / Fase 3A. Solo consulta. Datos sujetos a modificación.</p>
