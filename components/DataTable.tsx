...
export const TABLE_COLUMNS: TableColumn[] = [
  { key: 'ranking', label: '#', align: 'text-right', defaultVisible: true },
  ...
  return (
    <div className="bg-card border border-border rounded-sm shadow-sm overflow-hidden">
      ...
      <div className="w-full overflow-x-auto" aria-label="Tabla de resultados paginada">
        <table className="w-full min-w-0 lg:min-w-[920px] text-xs table-auto md:table-fixed border-separate border-spacing-0">
          <colgroup>
